...
export const GROUP_LIKERT_QUESTIONS: Record<string, SurveyQuestionConfig[]> = {
  ...
  "CG-TK": [
    ...
    { id: "TK2", text: "TK2. Biểu trưng cần vận hành hiệu quả trên các nền tảng được ứng dụng.", textEn: "TK2. The logo needs to operate effectively on the platforms where it is applied.", type: 'likert', required: true },
